			...
			<div class="admin-content-body">
				<div class="am-cf am-padding">
					<div class="am-fl am-cf">
						<strong class="am-text-primary am-text-lg">客户管理</strong> / <small>增加客户</small>
					</div>
				</div>
				<div class="am-g">
					<div class="am-u-sm-6 am-u-sm-centered">
						<div class="am-panel am-panel-primary">
							<div class="am-panel-hd">增加客户</div>
							<div class="am-panel-bd">
								<form class="am-form" id="customer-form"
									action="${pageContext.request.contextPath}/customer/create.do"
									method="POST">
									<div class="am-g">
										<div class="am-u-sm-12">
											...
											<button class="am-btn am-btn-primary am-btn-lg am-btn-block" type="submit">增加</button>
										</div>
									</div>
								</form>
							</div>
