...
<%@ include file="../common/header.jsp" %>
			...
			<div class="admin-content-body">
				<div class="am-cf am-padding">
					<div class="am-fl am-cf">
						<strong class="am-text-primary am-text-lg">快递管理</strong> / <small>编辑快递</small>
					</div>
				</div>
				<div class="am-g">
					<div class="am-u-sm-6 am-u-sm-centered">
						<div class="am-panel am-panel-primary">
							<div class="am-panel-hd">编辑快递</div>
							<div class="am-panel-bd">
								<form class="am-form" id="express-form"
									action="${pageContext.request.contextPath}/express/update.do"
									method="POST">
									<div class="am-g">
										<div class="am-u-sm-12">
											...
											<div class="am-form-group">
												<label for="name">姓名:</label> <input id="name" type="text"
													name="name" minlength="3" placeholder="输入姓名" value="${express.recipient.name}" required />
											</div>
											<div class="am-form-group">
												<label for="phone_number">手机号码:</label> <input class="js-pattern-mobile" id="phone-number" type="text"
													name="phone_number" placeholder="输入手机号码" value="${express.recipient.phoneNumber}" autocomplete="off" required />
											</div>
											<div class="am-form-group">
												<label for="name">地址:</label> <select id="area" name="area" data-am-selected="{btnWidth: '100%'}" data-parent="350681110000" required></select>
											</div>
											<div class="am-form-group date">
												<label for="phone_number">日期:</label>
												<div class="am-input-group am-datepicker-date" id="arrive-date" data-am-datepicker>
											...
											<div class="am-form-group">
												...
												<label class="am-radio-inline">
													<input type="radio" name="status" value="0" <c:if test="${express.status==0}">checked</c:if>> 未签收
												</label>
												<label class="am-radio-inline">
													<input type="radio" name="status" value="1" <c:if test="${express.status==1}">checked</c:if>> 已签收
												</label>
											</div>
	...
	if ($.AMUI && $.AMUI.validator) {
		...
		$('#arrive-date').datepicker('setValue', new Date('${express.arriveDate}'));
	</script>
</body>
</html>